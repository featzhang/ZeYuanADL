...
public class Lunar {
     ...
     *
     * @param year_log 年  month_log 月 day_log 日
     * @return y年m月d日对应的农历
     */
    public String getLunarDateString(int year_log, int month_log, int day_log) {
        ...
        if (((chineseMonth) == 1) && chineseDay == 1) {
            ...
            return chineseNumber[chineseMonth - 1] + "月";
        } else {
    ...
    public String toString() {
        if ((chineseNumber[chineseMonth - 1] == null ? "一" == null
                : chineseNumber[chineseMonth - 1].equals("一"))
                && (getChinaDayString(chineseDay) == null ? "初一" == null
                : getChinaDayString(chineseDay).equals("初一"))) {
            return "农历" + chineseYear + "年";
        } else if (getChinaDayString(chineseDay) == null ? "初一" == null
                : getChinaDayString(chineseDay).equals("初一")) {
            return chineseNumber[chineseMonth - 1] + "月";
        } else {
            return getChinaDayString(chineseDay);
